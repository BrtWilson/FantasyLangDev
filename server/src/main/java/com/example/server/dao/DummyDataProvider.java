...
public class DummyDataProvider {
    ...
    private final User user1 = new User("Ash", "Ahketchum", MALE_IMAGE_URL);
    private final User user2 = new User("Amy", "Ames", FEMALE_IMAGE_URL);
    private final User user3 = new User("Bob", "Bross", MALE_IMAGE_URL);
    private final User user4 = new User("Bonnie", "Betty", FEMALE_IMAGE_URL);
    private final User user5 = new User("Captain", "Chris", MALE_IMAGE_URL);
    ...
    private final User user15 = new User("Hagrid", "Henderson", MALE_IMAGE_URL);
    private final User user16 = new User("Helen", "Hopwell", FEMALE_IMAGE_URL);
    private final User user17 = new User("Igor", "Isaacson", MALE_IMAGE_URL);
    private final User user18 = new User("Draco", "Malphoy", FEMALE_IMAGE_URL);
    private final User user19 = new User("Luna", "Lovegood", MALE_IMAGE_URL);
    private final User user20 = new User("Harry", "Potter", FEMALE_IMAGE_URL);
    ...
    private final User user22 = new User("Luke", "Skywalker", FEMALE_IMAGE_URL_1);
    private final User user23 = new User("Anakin", "Skywalker", MALE_IMAGE_URL_1);
    private final User user24 = new User("Mace", "Windu", FEMALE_IMAGE_URL_1);
    private final User user25 = new User("Obi-wan", "Kenobi", MALE_IMAGE_URL_1);
    private final User user26 = new User("Sokka", "Sacapuntes", FEMALE_IMAGE_URL_1);
    private final User user27 = new User("Aang", "Jones", MALE_IMAGE_URL_1);
    private final User user28 = new User("The Fatherlord", "Smith", FEMALE_IMAGE_URL_1);
    private final User user29 = new User("Darth", "Vader", MALE_IMAGE_URL_1);
    private final User user30 = new User("Darth", "Plagueis", FEMALE_IMAGE_URL_1);
    private final User user31 = new User("Chancellor", "Palpatine", MALE_IMAGE_URL_1);
    private final User user32 = new User("The", "Senate", FEMALE_IMAGE_URL_1);
    private final User user33 = new User("Toph", "The Destroyer", MALE_IMAGE_URL_1);
    private final User user34 = new User("Cairne", "Bloodhoof", FEMALE_IMAGE_URL_1);
    private final User user35 = new User("Prince", "Arthas", MALE_IMAGE_URL_1);
    private final User user36 = new User("Opinionated Karen", "Smith", FEMALE_IMAGE_URL_1);
    private final User user37 = new User("Cleric", "Uther", MALE_IMAGE_URL_1);
    private final User user38 = new User("Frost", "The Undertaker", FEMALE_IMAGE_URL_1);
    private final User user39 = new User("Nope", "Sauce", MALE_IMAGE_URL_1);
    private final User user40 = new User("Han", "Solo", FEMALE_IMAGE_URL_1);
